...
const anime_image_manifest_json_1 = __importDefault(require("./anime-image-manifest.json"));
...
function getFileList() {
    return anime_image_manifest_json_1.default
...
router.get('/batch', async (req, res) => {
    ...
    if (slice.length === 0)
        return res.status(404).send('Batch out of range.');
...
//# sourceMappingURL=image-migrator.js.map